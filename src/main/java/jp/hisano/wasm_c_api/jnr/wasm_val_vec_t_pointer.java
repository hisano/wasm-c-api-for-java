...
public final class wasm_val_vec_t_pointer extends wasm_t_pointer {
	@FromNative(nativeType = Pointer.class)
	public static wasm_val_vec_t_pointer fromNative(Pointer value, FromNativeContext context) {
		return value != null ? new wasm_val_vec_t_pointer(value) : null;
	}

	@ToNative(nativeType = Pointer.class)
	public static Pointer toNative(wasm_val_vec_t_pointer value, ToNativeContext context) {
